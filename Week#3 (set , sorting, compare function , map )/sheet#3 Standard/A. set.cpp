...
void solve() {
    ...
    sl s;
    while(n--) {
        string command;cin >> command; int x; cin >> x;
        if(command=="insert") s.insert(x);
        ...
        {
            if(s.lower_bound(x)==s.end()) cout << -1 << nl;
            else cout << *s.lower_bound(x) << nl;
        }
        else if(command=="upper_bound")
        {
            if(s.upper_bound(x)==s.end()) cout << -1 << nl;
            else cout << *s.upper_bound(x) << nl;
        }
    }
