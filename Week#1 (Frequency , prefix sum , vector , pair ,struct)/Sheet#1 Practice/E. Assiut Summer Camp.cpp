...
void solve() {
    ...
    vl a;
    a.pb(A); a.pb(K); a.pb(M); a.pb(N);
    SORT(a);

    vs ans(2);
    F(i,0,4){
        ll j =0;
        if(a[3] == A) ans[j] = "Hussien";
        else if(a[3] == K) ans[j] = "Atef";
        else if(a[3] == M) ans[j] = "Karemo";
        else if(a[3] == N) ans[j] = "Ezzat";

        j= 1;
        if(a[2] == A) ans[j] = "Hussien";
        else if(a[2] == K) ans[j] = "Atef";
        else if(a[2] == M) ans[j] = "Karemo";
        else if(a[2] == N) ans[j] = "Ezzat";
    }
    show(ans);
